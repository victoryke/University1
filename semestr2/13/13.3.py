class Cell:
    def __init__(self, coorinatexy):
        self.coorinatexy = coorinatexy
        self.value = 0
...
class Board:
    ...
    def visitCell(self, cellcoorinatexy, playerNumber):
        if(self.cells[cellcoorinatexy].value == 0):
            self.cells[cellcoorinatexy].makeVisited(playerNumber)
